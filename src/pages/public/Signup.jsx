    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
      <div className="max-w-md w-full space-y-8 sm:space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base text-gray-500 font-light" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Create your account to begin</p>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-gray-100 shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2 sm:mb-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="mt-1.5 sm:mt-2 text-xs text-gray-500" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Must be at least 6 characters</p>
            </div>

            {/* Confirm Password Field */}
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 mb-2 sm:mb-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Confirm Password
              </label>
              <input
                id="confirmPassword"
